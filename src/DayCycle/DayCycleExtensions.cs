...
public static class DayCycleExtensions
{
	public class RoomSettingsExtension
	{
		...
		public Color[,] effectColors = new Color[2, 4]; // first dimension: 0, effect color A; 1, effect color B. second dimension same as those above
		public float[,] effectColorIntensities = new float[2, 4];
	...
	public static float[] PaletteIntensityAtTime(float t)
	{
		t %= 1f;
	...
	public static float Time(this RainWorldGame game)
	{
		return game.clock * 0.0001f;
	}
}
